package space.doky.simseok.sample2.uiview
...
import space.doky.simseok.sample2.uiview.databinding.ActivityMainBinding
import space.doky.simseok.sample2.uiview.fragment.CameraFragment
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.buttonSend.setOnClickListener {
            sendMessage(CameraFragment.message)
        }
    }
    ...
    companion object {
        ...
        enum class Label(val value: Int) {
            ...
            none(-99);
            companion object {
                fun find(value: Int): Label {
                    return Label.entries.find {it.value == value } ?: none
                }
            }
        }
    }
